...
\begin{figure}[H]
	\center{\includegraphics[width=0.8\linewidth]{./images/Diagrama de estructura.png}}
\end{figure}
...
\begin{figure}[H]
	\center{\includegraphics[width=0.3\linewidth]{./images/Actividad.png}}
\end{figure}
...
\begin{figure}[H]
	\center{\includegraphics[width=0.8\linewidth]{./images/Secuencia.png}}
\end{figure}
