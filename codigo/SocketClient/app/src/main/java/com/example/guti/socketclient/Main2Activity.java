...
public class Main2Activity extends AppCompatActivity {
    ...
    public final static String EXTRA_MESSAGE4 = "com.example.myfirstapp.EXTRA_MESSAGE4";
    ...
    public void agregar_usuario(View view) {
        ...
        //String message = "Agregar Nuevo Usuario";
        intent.putExtra(EXTRA_MESSAGE4, user_data);
        startActivity(intent);
    }
